...
class _DropdownRoute<T> extends PopupRoute<_DropdownRouteResult<T>> {
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
    ...
    final topInitialPadding = MediaQuery.of(context).padding.top;
    final bottomInitialPadding = MediaQuery.of(context).padding.bottom;

    final paddingTop = buttonRect.top - _kMenuItemHeight - _kMenuItemHeight * selectedIndex + topInitialPadding  + kMaterialListPadding.top;
    final paddingBottom = bottomInitialPadding;
...
//    final double screenHeight = MediaQuery.of(context).size.height;
//    final double maxMenuHeight = screenHeight;
//
...
/// Typically, an enum is used. Each [DropdownDirectMenuItem] in [items] must be
...
/// See also:
///
///  * [DropdownDirectMenuItem], the class used to represent the [items].
...
class DropdownButtonFormField<T> extends FormField<T> {
  ...
  DropdownButtonFormField({
    Key key,
    T value,
    @required List<DropdownDirectMenuItem<T>> items,
    this.onChanged,
